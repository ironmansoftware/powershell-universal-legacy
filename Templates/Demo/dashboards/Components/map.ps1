New-UDPage -Name 'New-UDMap' -Content {
    New-UDTypography -Text 'Basic Map' -Variant 'h4'
    ...
    New-UDTypography -Text 'Layer Control' -Variant 'h4'
    ...
    New-UDTypography -Text 'Heatmap' -Variant 'h4'
    ...
    New-UDTypography -Text 'Interactive Map' -Variant 'h4'
